...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFieWxlYXJuc3RvY29kZSIsImEiOiJja2R6bHRsY3Ezbmp6Mnd0dmFqN2RocXFhIn0.clWqbguDaGaIMBOrJvwyvw';
  var map = new mapboxgl.Map({
    // container= put map to element with ID #map
    container: 'map',
    style: 'mapbox://styles/babylearnstocode/ckdzlyqbx0krh1amilsk970tt',
    //zoom disable
    scrollZoom: false //interactive disable
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, " </p>")).addTo(map); //Extend the map bounds to include current Location
...
var stripe = Stripe('pk_test_51HIZBuCMVlMUoiYyIMArL2QaLhIiVtRqzwv9elEiWMyhSIUjmILhRJoze78zFJh6kLrnen3Cm9cZh2xdi12kxS6L005wjzoCVN');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              passwordConfirm = (_readOnlyError("passwordConfirm"), document.getElementById('password-confirm').value = '');
